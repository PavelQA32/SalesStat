...
class StatsServiceTest {
    ...
    void shouldCalculateMaxSaleMonth() {
        ...
        int[] sales = {8, 15, 13, 15, 17, 20, 19, 20, 7, 14, 14, 18};
        int expected = 8;
        int actual = service.calculateMaxSaleMonth(sales);
        assertEquals(expected,actual);
    }
    ...
    @Test
    void shouldCalculateBottomAvgMonths() {
        StatsService service = new StatsService();
        int[] sales = {8, 15, 13, 15, 17, 20, 19, 20, 7, 14, 14, 18};
        int expected = 5;
        int actual = service.calculateBottomAvgMonths(sales);
        assertEquals(expected,actual);
    }
    ...
    void shouldCalculateOverAvgMonths() {
        ...
        int[] sales = {8, 15, 13, 15, 17, 20, 19, 20, 7, 14, 14, 18};
        int expected = 5;
        int actual = service.calculateOverAvgMonths(sales);
        assertEquals(expected,actual);
    }
}